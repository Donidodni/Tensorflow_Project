...
parser.add_argument(
    "--model",
    help="Provide the path to the TFLite file, default is models/model.tflite",
    default="models/model.tflite",
)
parser.add_argument(
    "--labels",
    help="Provide the path to the Labels, default is models/labels.txt",
    default="models/labels.txt",
)
parser.add_argument(
    "--video", help="Name of the video to perform detection on", default="test.mp4"
)
parser.add_argument(
    "--threshold",
