...
def color_select(object_name):
    R = 0
    G = 0
    B = 0
    if int(object_name) == 0:
        R = 255
        G = 0
        B = 0
    elif int(object_name) == 1:
        R = 120
        G = 60
        B = 70
    elif int(object_name) == 2:
        R = 255
        G = 0
        B = 255
    elif int(object_name) == 3:
        R = 255
        G = 255
        B = 0
    elif int(object_name) % 25 < 10:
        R = 255
        G = 255
        B = 0
    elif int(object_name) % 25 > 10:
        ...
        R = int(object_name) % 15 + 100
        G = int(object_name) % 15 + 30
        B = int(object_name) % 15 + 10
...
out = cv2.VideoWriter("output.avi", cv2.VideoWriter_fourcc(*"DIVX"), 20.0, (1280, 720))
